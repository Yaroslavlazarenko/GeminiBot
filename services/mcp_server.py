...
# We export the raw functions as a list so they can be easily passed to Gemini's native tool handler
# while still being valid MCP tools if the FastMCP server is started.
gemini_tools = [
    disable_responses,
    do_not_respond,
    add_reaction,
