...
async def voice_handler(
    ...
    try:
        ...
        if is_forwarded:
            # This is a forwarded voice message
            ...
            # Regular non-forwarded voice message
        ...
        if not should_process_now:
            ...
            logger.info(f"Voice message from user {user_telegram_id} - waiting for batching period to end")
            return
