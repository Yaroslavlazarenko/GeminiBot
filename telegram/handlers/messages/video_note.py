...
@router.message(types.ContentType.VIDEO_NOTE)
async def handle_video_note(message: types.Message, state: FSMContext, user_dao: UserDAO, group_dao: GroupDAO, message_dao: MessageDAO):
    try:
        # Get or create user
